class Endpoint {
    ...
    handle() {
        this.app.post('/updateServerBanner', (async(req, res) => {
            if(!this.app.isSessionValid(this.app, req, res)) { return; }

            await this.updateServerBanner(req, res, req.query.serverID);
            console.log("> received server banner update - " + req.query.serverID);
        }).bind(this));
    }

    async updateServerBanner(req, res, serverID) {
        ...
        console.log("> received banner - " + fileName)
