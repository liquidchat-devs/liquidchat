    ...
    render(){
      const form = (
        <form onSubmit={this.handleSubmit}  >
          ...
          <input className="inputfield1 margin1" name="password" type="text" placeholder="Password..." required={true} onChange={this.handleChange}  /><br />
          <input className="inputfield1 margin1" name="password2" type="text" placeholder="Repeat password..." required={true} onChange={this.handleChange}  />
        </form>
        );
      return (
