    ...
    return (
      <div>
        ...
        <div className="absolutepos overlaybox2 statusDialog" style={{ left: this.props.state.boxX, top: this.props.state.boxY - 180, height: 180, background: "none" }}>
          <div className="button3 hover chatColor aligny firstBorder" onClick={() => { this.props.API.API_updateStatus(1); this.props.functions.switchDialogState(-1); }}>
          ...
          <div className="button3 hover chatColor aligny" onClick={() => { this.props.API.API_updateStatus(2); this.props.functions.switchDialogState(-1); }}>
          ...
          <div className="button3 hover chatColor aligny" onClick={() => { this.props.API.API_updateStatus(3); this.props.functions.switchDialogState(-1); }}>
          ...
          <div className="button3 hover chatColor aligny" onClick={() => { this.props.API.API_updateStatus(0); this.props.functions.switchDialogState(-1); }}>
