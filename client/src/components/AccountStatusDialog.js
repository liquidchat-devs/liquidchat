    ...
    return (
      <div>
        ...
        <div className="absolutepos overlaybox2" style={{ left: this.props.boxX, top: this.props.boxY - 128, height: 128, background: "none" }}>
          <div className="button3 chatColor aligny firstBorder" onClick={() => { this.props.API.API_updateStatus(1); }}>
          ...
          <div className="button3 chatColor aligny" onClick={() => { this.props.API.API_updateStatus(2); }}>
          ...
          <div className="button3 chatColor aligny" onClick={() => { this.props.API.API_updateStatus(3); }}>
          ...
          <div className="button3 chatColor aligny lastBorder" onClick={() => { this.props.API.API_updateStatus(0); }}>
