      ...
      <div>
        ...
        <div className="absolutepos overlaybox2" style={{ left: this.props.boxX, top: this.props.boxY, height: this.props.selectedUser.id === this.props.session.userID ? 30 : 45  }}>
          ...
          </div>
          {
            ...
            <div className="button2 hover alignmiddle chatColor" onClick={() => { this.sendFriendRequest(this.props.selectedUser.id); }}>
          ...
          }
          {
            ...
            <div>
              <div className="button2 hover alignmiddle chatColor" onClick={() => { this.removeFriend(this.props.selectedUser.id); }}>
                <p className="white text1">> Remove Friend</p>
              </div>
              <div className="button2 hover alignmiddle chatColor" onClick={() => { this.dmUser(this.props.selectedUser.id); }}>
          ...
          }
          {
            ...
            <div>
              <div className="button2 hover alignmiddle chatColor" onClick={() => { this.removeFromDMChannel(currentChannel.id ,this.props.selectedUser.id); }}>
          ...
          }
          {
            ...
            <div>
              <div className="button2 hover alignmiddle chatColor" onClick={() => { this.removeFromServer(currentServer.id ,this.props.selectedUser.id); }}>
                <p className="white text1">> Kick from server</p>
              </div>
            </div> :
            ""
          }
          <div className="button2 hover alignmiddle chatColor" onClick={() => { this.props.copyID(this.props.selectedUser.id); }}>
