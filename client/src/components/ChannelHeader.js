        ...
        return (
          <div className="chatColor fullwidth channelHeader">
            ...
            <div className="aligny fullheight channelSection2">
              ...
              <div className="button4 hover alignmiddle chatColor" onClick={(e) => { this.props.functions.switchDialogState(25); }}>
                <svg className="headerButton" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M22.314 10.172l-1.415 1.414-.707-.707-4.242 4.242-.707 3.536-1.415 1.414-4.242-4.243-4.95 4.95-1.414-1.414 4.95-4.95-4.243-4.242 1.414-1.415L8.88 8.05l4.242-4.242-.707-.707 1.414-1.415z" fill="rgba(255,91,91,1)"/></svg>
              </div>
            </div>
          </div>
        );
